...
UI = {
    "tr": dict(
        ...
        f_opts=["Randevu sistemi", "Sipariş ve QR menü", "Web sitesi", "Yapay zeka asistanı", "Telefon uygulaması", "Bilmiyorum, önerin"],
    ...
    "en": dict(
        ...
        f_opts=["Booking system", "Ordering & QR menu", "Website", "AI assistant", "Phone app", "Not sure, suggest something"],
